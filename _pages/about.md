...
<br>
<small>
I’m a PhD candidate at [Aalto University](https://www.aalto.fi/en) researching Computational Interaction as part of the [Computational Behavior Lab](http://cbl.aalto.fi/), led by [Prof Antti Oulasvirta](https://users.aalto.fi/~oulasvir/). While my defense is scheduled in December 2023 (dissertation: [**Human-in-the-Loop Design Optimization**](http://yichiliao.github.io/files/Human-in-the-Loop_Design_Optimization.pdf)), I have joined [Saarland University](https://www.uni-saarland.de/en/home.html) as a postdoc researcher, jointly supervised by [Prof Jürgen Steimle](https://hci.cs.uni-saarland.de/people/juergen-steimle/) and [Prof Anna Feit](http://annafeit.de/). Previously, I worked in [Meta Rality Labs](https://tech.fb.com/ar-vr/) as a research intern. Even before this, I received my bachelor’s and master’s degree at [National Taiwan University](https://www.ntu.edu.tw/english/). My research focus is to develop future design framework based on simulation, modeling and optimization. Specifically, I have rich experience in applying advanced **Bayesian optimization**, **deep reinforcement learning**, **meta-learning**, and **biomechnical simulation** for addressing design and interaction tasks. [My previous publications](https://scholar.google.com/citations?user=Ddny4V4AAAAJ&hl=en) are in peer-reviewed venues, including CHI, UIST, and SIGGRAPH, the top human-computer interaction venues from the ACM. I also lecture on various topics in Aalto, including input and sensing, Bayesian decoders, Bayesian data analysis, and Deep Learning. I am also activately involving in HCI-related academic activities, such as reviewing papers, organizing CHI, and being an AC for CHI.
</small>
