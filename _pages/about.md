...
---
# **Yi-CHi Liao (廖以圻)**
I am a postdoctoral fellow in [SIPLab](https://siplab.org/) (led by [Prof. Christian Holz](https://www.christianholz.net/)) at the Department of Computer Science, [ETH Zürich](https://ethz.ch/en.html), supported by the [ETH Zürich Postdoctoral Fellowship Programme](https://ethz.ch/en/research/research-promotion/eth-fellowships.html). My research lies at the intersection of Human–Computer Interaction (HCI), Computational Interaction, and Computational Design. In particular, I develop **human-in-the-loop optimization** methods that enable interactive systems to learn directly from human behavior and preferences to automatically optimize interface designs, supporting **efficient adaptation and scalable human–AI collaboration**.
<br>
<br>
My work advances human-in-the-loop optimization along three directions: (1) expanding its scope to address increasingly complex and open-ended design tasks, (2) improving optimization efficiency to enable real-time interface adaptation, and (3) scaling these methods with growing interaction data and prior experience.
<br>
<br>
