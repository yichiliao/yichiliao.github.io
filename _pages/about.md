...
<br>
<br>
Particularly, my work advances optimization in interface design along three directions: (1) expanding its scope to address increasingly complex and open-ended design tasks, (2) improving optimization efficiency to enable real-time interface adaptation, and (3) scaling these methods with growing interaction data and prior experience.
<br>
<br>
